  ...
  return (
    <ThemedView style={[styles.container, { paddingTop: Math.max(insets.top, 18) }]}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Section title="About"><Card><Row label="Version" value="1.2.1" /><Row label="Storage mode" value="Offline only" divider /><Row label="License" value="MIT" divider /></Card></Section>
      </ScrollView>
    </ThemedView>
  );
}
